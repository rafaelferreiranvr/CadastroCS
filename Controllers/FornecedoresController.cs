...
namespace CadastroCS.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Cnpj,Segmento,Cep,Endereco,Perfil")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Cnpj,Segmento,Cep,Endereco,Perfil")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
